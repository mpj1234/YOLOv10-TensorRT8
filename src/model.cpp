...
//	nvinfer1::INetworkDefinition *network = builder->createNetworkV2(0U);
    ...
    *******************************************************************************************************/
    auto *conv0 =
            convBnSiLU(network, weightMap, *data, get_width(64, gw, max_channels), 3, 2, "model.0");
    auto *conv1 =
    ...
    auto *conv5 =
            SCDown(network, weightMap, *conv4->getOutput(0), get_width(512, gw, max_channels), 3, 2, "model.5");
    // 22466
    ...
    auto *conv7 =
            SCDown(network, weightMap, *conv6->getOutput(0), get_width(1024, gw, max_channels), 3, 2, "model.7");
    // 11233
    auto *conv8 =
    ...
    auto *conv10 =
            PSA(network, weightMap, *conv9->getOutput(0), get_width(1024, gw, max_channels), "model.10");
    /*******************************************************************************************************
    *********************************************  YOLOV10 HEAD  ********************************************
    *******************************************************************************************************/
    ...
    auto *conv13 =
            C2F(network, weightMap, *cat12->getOutput(0), get_width(512, gw, max_channels),
    ...
    auto *conv16 =
            C2F(network, weightMap, *cat15->getOutput(0), get_width(256, gw, max_channels),
                get_width(256, gw, max_channels), get_depth(3, gd), false, 0.5, "model.16");
    auto *conv17 = convBnSiLU(network, weightMap, *conv16->getOutput(0),
                              get_width(256, gw, max_channels), 3, 2, "model.17");
    ...
    auto *conv19 =
            C2F(network, weightMap, *cat18->getOutput(0), get_width(512, gw, max_channels),
                get_width(512, gw, max_channels), get_depth(3, gd), false, 0.5, "model.19");
    auto *conv20 = SCDown(network, weightMap, *conv19->getOutput(0), get_width(512, gw, max_channels), 3, 2,
                          "model.20");
    ...
    auto *conv22 =
            C2fCIB(network, weightMap, *cat21->getOutput(0), get_width(1024, gw, max_channels),
    ...
    *******************************************************************************************************/
    ...
    auto *conv23_cv2_0_1 =
            convBnSiLU(network, weightMap, *conv23_cv2_0_0->getOutput(0), base_in_channel, 3, 1,
    ...
    nvinfer1::IConvolutionLayer *conv23_cv2_0_2 =
            network->addConvolutionNd(*conv23_cv2_0_1->getOutput(0), 64, nvinfer1::DimsHW{1, 1},
                                      weightMap["model.23.one2one_cv2.0.2.weight"],
    ...
    auto *conv23_cv3_0_0_0 =
            convBnSiLU(network, weightMap, *conv16->getOutput(0), get_width(256, gw, max_channels), 3, 1,
                       "model.23.one2one_cv3.0.0.0", get_width(256, gw, max_channels));
    auto *conv23_cv3_0_0_1 =
            convBnSiLU(network, weightMap, *conv23_cv3_0_0_0->getOutput(0), base_out_channel, 1, 1,
                       "model.23.one2one_cv3.0.0.1");
    auto *conv23_cv3_0_1_0 =
            convBnSiLU(network, weightMap, *conv23_cv3_0_0_1->getOutput(0), base_out_channel, 3, 1,
                       "model.23.one2one_cv3.0.1.0", base_out_channel);
    auto *conv23_cv3_0_1_1 =
            convBnSiLU(network, weightMap, *conv23_cv3_0_1_0->getOutput(0), base_out_channel, 1, 1,
    ...
    auto *conv23_cv2_1_1 =
            convBnSiLU(network, weightMap, *conv23_cv2_1_0->getOutput(0), base_in_channel, 3, 1,
    ...
    nvinfer1::IConvolutionLayer *conv23_cv2_1_2 =
            network->addConvolutionNd(*conv23_cv2_1_1->getOutput(0), 64, nvinfer1::DimsHW{1, 1},
                                      weightMap["model.23.one2one_cv2.1.2.weight"],
    ...
    auto *conv23_cv3_1_0_0 =
            convBnSiLU(network, weightMap, *conv19->getOutput(0), get_width(512, gw, max_channels), 3, 1,
                       "model.23.one2one_cv3.1.0.0", get_width(512, gw, max_channels));
    auto *conv23_cv3_1_0_1 =
            convBnSiLU(network, weightMap, *conv23_cv3_1_0_0->getOutput(0), base_out_channel, 1, 1,
                       "model.23.one2one_cv3.1.0.1");
    auto *conv23_cv3_1_1_0 =
            convBnSiLU(network, weightMap, *conv23_cv3_1_0_1->getOutput(0), base_out_channel, 3, 1,
                       "model.23.one2one_cv3.1.1.0", base_out_channel);
    auto *conv23_cv3_1_1_1 =
            convBnSiLU(network, weightMap, *conv23_cv3_1_1_0->getOutput(0), base_out_channel, 1, 1,
    ...
    auto *conv23_cv2_2_1 =
            convBnSiLU(network, weightMap, *conv23_cv2_2_0->getOutput(0), base_in_channel, 3, 1,
    ...
    nvinfer1::IConvolutionLayer *conv23_cv2_2_2 =
            network->addConvolutionNd(*conv23_cv2_2_1->getOutput(0), 64, nvinfer1::DimsHW{1, 1},
                                      weightMap["model.23.one2one_cv2.2.2.weight"],
                                      weightMap["model.23.one2one_cv2.2.2.bias"]);
    auto *conv23_cv3_2_0_0 =
            convBnSiLU(network, weightMap, *conv22->getOutput(0), get_width(1024, gw, max_channels), 3, 1,
                       "model.23.one2one_cv3.2.0.0", get_width(1024, gw, max_channels));
    auto *conv23_cv3_2_0_1 =
            convBnSiLU(network, weightMap, *conv23_cv3_2_0_0->getOutput(0), base_out_channel, 1, 1,
                       "model.23.one2one_cv3.2.0.1");
    auto *conv23_cv3_2_1_0 =
            convBnSiLU(network, weightMap, *conv23_cv3_2_0_1->getOutput(0), base_out_channel, 3, 1,
                       "model.23.one2one_cv3.2.1.0", base_out_channel);
    auto *conv23_cv3_2_1_1 =
            convBnSiLU(network, weightMap, *conv23_cv3_2_1_0->getOutput(0), base_out_channel, 1, 1,
    ...
    *******************************************************************************************************/
    ...
    nvinfer1::IPluginV2Layer *yolo =
            addYoLoLayer(network, std::vector<nvinfer1::ILayer *>{cat23_dfl_0, cat23_dfl_1, cat23_dfl_2},
...
//	nvinfer1::INetworkDefinition *network = builder->createNetworkV2(0U);
    ...
    *******************************************************************************************************/
    ...
    // 11233
    auto *conv8 =
            C2fCIB(network, weightMap, *conv7->getOutput(0), get_width(1024, gw, max_channels),
...
//	nvinfer1::INetworkDefinition *network = builder->createNetworkV2(0U);
    ...
    *******************************************************************************************************/
    ...
    nvinfer1::IConcatenationLayer *cat18 = network->addConcatenation(inputTensor18, 2);
    auto *conv19 =
            C2fCIB(network, weightMap, *cat18->getOutput(0), get_width(512, gw, max_channels),
...
//	nvinfer1::INetworkDefinition *network = builder->createNetworkV2(0U);
    ...
    *******************************************************************************************************/
    ...
    auto *conv13 =
            C2fCIB(network, weightMap, *cat12->getOutput(0), get_width(512, gw, max_channels),
